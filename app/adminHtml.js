  ...
  <div id="dashView" class="d-none">
    <nav class="navbar bg-white shadow-sm sticky-top">
      <div class="container-fluid px-4">
        <span class="navbar-brand fw-bold text-primary d-flex align-items-center gap-2">
          <svg width="26" height="26" stroke-width="3.2" fill="none" stroke="currentColor" viewBox="0 0 200 200">
            <path d="M 114.72 116.35 A 22 22 0 1 1 121.52 95.43" />
            <path d="M 122.66 137.72 A 44 44 0 1 1 143.83 103.83" />
            <path d="M 123.68 149.64 A 55 55 0 1 1 153.48 112.84" />
          </svg> AVN Admin
    ...
    <div class="container py-5">
      <ul class="nav nav-pills gap-2 mb-4">
        <li class="nav-item"><button class="nav-link active" data-tab="content">Homepage Content</button></li>
        <li class="nav-item"><button class="nav-link" data-tab="enquiries">Enquiries <span id="enqCount"
              class="badge bg-primary ms-1 d-none">0</span></button></li>
      </ul>
      ...
      <!-- Enquiries -->
      <div id="tab-enquiries" class="d-none">
